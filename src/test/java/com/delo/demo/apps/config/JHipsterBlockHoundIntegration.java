package com.delo.demo.apps.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.delo.demo.apps.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.delo.demo.apps.security.DomainUserDetailsService", "createSpringSecurityUser");
